...
public class PrivateListJiBaoAdapter extends BaseAdapter {
	private Context mContext;
	private LayoutInflater mInflater;
	private List<JiBaoSQLite> list;
	public String text_data_string, text_station_msg;

	public PrivateListJiBaoAdapter(Context context,List<JiBaoSQLite> list) {
	...
	public void setmMessageItems(List<JiBaoSQLite> list) {
		this.list = list;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.text_data.setText(item.getBillCode() +"   "+ item.getBagNumber());
